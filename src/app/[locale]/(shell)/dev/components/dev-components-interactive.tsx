...
export function DevComponentsInteractive() {
  ...
  return (
    <>
      ...
      <Row label="RadioGroup card — quiz variant">
        <div className="w-full max-w-md">
          <RadioGroup name="quiz-card" value={cardValue} onChange={setCardValue}>
            <Radio value="a" variant="card">
              ephemeral
            </Radio>
            <Radio value="b" variant="card">
              transient
            </Radio>
            <Radio value="c" variant="card" className={theme.radioCardNuance}>
              The sunset was beautiful, but the feeling was gone by morning.
            </Radio>
          </RadioGroup>
        </div>
      </Row>
